...
class SimConfig(BaseModel):
    ...
    scenario: str = Field(default="tsrd", description="Scenario preset id")
    scheduler: str = Field(default="rfi_ucb", description="Scheduler for the smart scanner")
    ...
    step_ms: int = Field(default=300, ge=20, le=5000, description="Live feed delay per time step (ms)")
